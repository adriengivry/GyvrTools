...
#pragma once
#ifndef _GYVRTOOLS_ARESOURCEMANAGER_INL
#define _GYVRTOOLS_ARESOURCEMANAGER_INL

#include "AResourceManager.h"

#include <fstream>

namespace GyvrTools::Managers
{
	template<typename T>
	...
	inline void AResourceManager<T>::LoadPaths(const std::string & l_pathFile)
	{
		...
		GyvrTools::System::ErrorHandler::RegisterError("Failed loading the path file: " + l_pathFile);
	}
}

#endif // _GYVRTOOLS_ARESOURCEMANAGER_INL
